...
class RegisterViewModel(
    ...
    private val _validationEvents = MutableLiveData<ValidationEvent>()
    val validationEvents: LiveData<ValidationEvent>
        get() = _validationEvents
